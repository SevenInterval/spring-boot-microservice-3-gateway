package com.ridvan.springbootmicroservice3gateway.request;
...
public class RetrofitConfiguration {
    ...
    @Bean
    public IProductServiceRequest productServiceRequest(Retrofit.Builder secureKeyBuilder, @Value("${product.service.url}") String baseUrl) {
    ...
    @Bean
    public ITransactionServiceRequest transactionServiceRequest(Retrofit.Builder secureKeyBuilder, @Value("${transaction.service.url}") String baseUrl) {
        return secureKeyBuilder
                .baseUrl(baseUrl)
                .build()
